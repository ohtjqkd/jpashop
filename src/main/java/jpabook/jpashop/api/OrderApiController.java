...
public class OrderApiController {
    ...
    public List<OrderQueryDto> ordersV5() {
        return orderQueryRepository.findOrderQueryDtoWithCollection();
    }

    @GetMapping("/api/v6/orders")
    public List<OrderQueryDto> ordersV6() {
        List<OrderFlatDto> orderFlatDtos = orderQueryRepository.findAllByDtoFlat();
        List<OrderQueryDto> result = orderFlatDtos.stream()
